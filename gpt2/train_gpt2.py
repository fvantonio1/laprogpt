...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # not really a 'bias', more of a mask, but following the OpenAI/HF namin though
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        pos_emb = self.transformer.wpe(pos) # position embeddings ofshape (T, n_embd)
    ...
    def configure_optimizers(self, weight_decay, learning_rate, device):
        ...
        # create optim groups. Any parameter that is @D will be weight decayed, otherwise no.
